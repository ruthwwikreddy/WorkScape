...
import { Zap, ArrowRight, User, LogOut, ChevronRight, Mic, Layout, Shield, Video, MessageSquare, Globe } from 'lucide-react';
...
const DeviceNotSupported = ({ onBack }: { onBack: () => void }) => (
  <div className="fixed inset-0 z-[5000] bg-black flex flex-col items-center justify-center p-8 text-center">
    ...
    >
      ...
      <h2 className="text-3xl font-black text-white mb-4">Device Not Supported</h2>
      ...
      <button
        onClick={onBack}
        className="px-8 py-3 bg-white text-black rounded-xl font-black hover:bg-gray-200 transition-colors"
      >
        Go Back
      </button>
    </motion.div>
...
const LandingPage = ({ onStart, user }: { onStart: () => void; user: any }) => {
  ...
  const faqs = [
    {
      question: "What is WorkScape?",
      answer: "WorkScape is a spatial virtual office platform that brings your team together in a shared digital workspace. Walk around, talk naturally with proximity voice, and collaborate in real-time just like in a real office."
    },
    {
      question: "How does proximity voice work?",
      answer: "Proximity voice means you hear people based on how close you are to them. Walk closer to someone to hear them better, step away for privacy. It creates natural, spontaneous conversations without scheduling meetings."
    },
    {
      question: "Is my data secure?",
      answer: "Absolutely. We use industry-standard encryption for all communications, and your workspace data is stored securely. Private conversations stay private with our isolated audio bubble technology."
    },
    {
      question: "Can I customize my avatar?",
      answer: "Yes! You can fully customize your avatar with different hairstyles, outfits, body types, and accessories. You can even use your Google profile photo as your avatar."
    },
    {
      question: "What devices are supported?",
      answer: "WorkScape is optimized for desktop browsers (Chrome, Firefox, Safari, Edge) for the best experience. Mobile and tablet support is coming soon."
    }
  ];
  ...
  const testimonials = [
    {
      name: "Sarah Chen",
      role: "CEO, TechStart",
      text: "WorkScape transformed our remote culture. The spontaneous conversations and natural interactions made our team feel closer than ever.",
      avatar: "SC"
    },
    {
      name: "Marcus Johnson",
      role: "Engineering Lead, CloudScale",
      text: "The proximity voice feature is incredible. No more scheduled calls for quick questions - just walk over and talk. It's like being in the office.",
      avatar: "MJ"
    },
    {
      name: "Emily Rodriguez",
      role: "Product Manager, InnovateCo",
      text: "Our team collaboration improved dramatically. The spatial layout and meeting rooms make it easy to organize work without feeling isolated.",
      avatar: "ER"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans relative">
      {/* Navigation */}
      <nav className="fixed top-6 left-1/4 right-1/4 z-50 bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center">
              <Zap className="w-5 h-5 text-black" />
            </div>
            <span className="text-xl font-black tracking-tight">WorkScape</span>
          </div>
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="font-bold text-sm hover:text-gray-300 transition-colors">Features</a>
            <a href="#how-it-works" className="font-bold text-sm hover:text-gray-300 transition-colors">How It Works</a>
            <a href="#testimonials" className="font-bold text-sm hover:text-gray-300 transition-colors">Testimonials</a>
            <a href="#faq" className="font-bold text-sm hover:text-gray-300 transition-colors">FAQ</a>
          </div>
            ...
            {user ? (
              <div className="relative group">
                <img 
                  ...
                  alt="profile" 
                  className="w-10 h-10 rounded-xl border-2 border-white/20 hover:border-white/40 transition-all cursor-pointer"
                ...
                <div className="absolute top-full right-0 mt-2 opacity-0 group-hover:opacity-100 transition-all pointer-events-none group-hover:pointer-events-auto">
                  <div className="bg-white rounded-xl shadow-2xl border border-white/10 p-2 min-w-[160px]">
                    <button 
                      onClick={() => auth.signOut()}
                      className="w-full flex items-center gap-3 px-4 py-3 text-red-600 hover:bg-red-50 rounded-lg transition-colors font-black text-xs uppercase tracking-widest"
                    >
              ...
              <button
                onClick={handleStart}
                className="px-6 py-3 bg-white text-black rounded-xl font-black text-sm hover:bg-gray-200 transition-all"
              >
                Sign In
              </button>
            )}
      ...
      <section id="features" className="py-24 px-6 relative">
        <div className="absolute top-0 left-1/4 w-64 h-64 bg-purple-500/10 rounded-full blur-[100px]" />
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: <Mic className="w-8 h-8" />, title: "Proximity Voice", desc: "Hear people louder as you walk closer. Natural conversations without scheduling calls.", gradient: "from-purple-500/20 to-transparent" },
              { icon: <Layout className="w-8 h-8" />, title: "Spatial Office", desc: "Beautiful 2D office layout with meeting rooms, focus zones, and collaborative spaces.", gradient: "from-blue-500/20 to-transparent" },
              { icon: <Shield className="w-8 h-8" />, title: "Private Bubbles", desc: "Need a quick 1-on-1? Step into a private bubble for isolated, secure conversations.", gradient: "from-green-500/20 to-transparent" },
              { icon: <Video className="w-8 h-8" />, title: "Video Meetings", desc: "Seamless video integration for screen sharing and face-to-face collaboration.", gradient: "from-red-500/20 to-transparent" },
              { icon: <MessageSquare className="w-8 h-8" />, title: "Team Chat", desc: "Persistent chat channels for async communication and quick updates.", gradient: "from-yellow-500/20 to-transparent" },
              { icon: <Globe className="w-8 h-8" />, title: "Multi-Region", desc: "Low-latency servers worldwide ensure smooth performance for global teams.", gradient: "from-cyan-500/20 to-transparent" }
            ].map((f, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${f.gradient} rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
                <div className="relative bg-white/5 border border-white/10 p-8 rounded-3xl hover:border-white/30 transition-all backdrop-blur-sm">
                  <div className="mb-6 text-gray-400 group-hover:text-white transition-colors">{f.icon}</div>
      ...
      <section id="how-it-works" className="py-24 px-6 bg-white/5 border-y border-white/10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: "01", title: "Sign Up", desc: "Create your account with Google or email. Takes less than 30 seconds." },
              { step: "02", title: "Customize", desc: "Design your avatar and join your team's workspace or create a new one." },
              { step: "03", title: "Collaborate", desc: "Walk around, talk naturally, and work together in real-time." }
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
                ...
                className="relative"
              >
                <div className="text-8xl font-black text-white/5 absolute -top-4 -left-4">{item.step}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <motion.div
                ...
                className="relative group"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative bg-white/5 border border-white/10 p-8 rounded-3xl hover:border-white/30 transition-all backdrop-blur-sm">
                  ...
                  <p className="text-gray-300 font-medium mb-6 leading-relaxed">"{t.text}"</p>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-white to-gray-200 rounded-full flex items-center justify-center text-black font-black shadow-lg">
                      {t.avatar}
                    </div>
                    <div>
      ...
      <section id="faq" className="py-24 px-6 relative">
        <div className="absolute top-1/4 left-0 w-64 h-64 bg-purple-500/10 rounded-full blur-[100px]" />
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              ...
              >
                ...
                <div className="relative bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-white/30 transition-all backdrop-blur-sm">
                  <button
                    onClick={() => toggleFaq(i)}
                  ...
                  <AnimatePresence>
                    {activeFaq === i && (
                      ...
                      >
                        <p className="px-6 pb-5 text-gray-400 font-medium leading-relaxed">{faq.answer}</p>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </div>
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          >
            Ready to transform<br />your team's collaboration?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Join thousands of teams already using WorkScape to work together, anywhere.
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            whileHover={{ scale: 1.05, boxShadow: "0 20px 40px rgba(255,255,255,0.3)" }}
            whileTap={{ scale: 0.95 }}
            className="px-12 py-6 bg-gradient-to-r from-white to-gray-200 text-black rounded-2xl font-black text-2xl shadow-2xl flex items-center justify-center gap-3 mx-auto relative overflow-hidden group"
          >
      ...
      <footer className="py-12 px-6 border-t border-white/10">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-500 font-bold">© 2024 WorkScape. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
